...
git submodule add git@github.com:%GIT_FORK_HOST%/email-sender.git email-sender
cd email-sender
...
git submodule add git@github.com:%GIT_FORK_HOST%/certifica-utf-auth.git certifica-utf-auth
...
git submodule add git@github.com:%GIT_FORK_HOST%/uploader.git uploader
cd uploader
...
git submodule add git@github.com:%GIT_FORK_HOST%/certifica-utf-gateway.git certifica-utf-gateway
...
git submodule add git@github.com:%GIT_FORK_HOST%/certifica-utf-back-end.git certifica-utf-back-end
...
git submodule add git@github.com:%GIT_FORK_HOST%/certifica-utf-service-registry.git certifica-utf-service-registry
